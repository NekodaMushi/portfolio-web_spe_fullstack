...
export const quizzesCompleted = pgTable("quizzesCompleted", {
  ...
  above60FourTime: integer("above_60_four_time").notNull().default(0),
  above70ThreeTime: integer("above_70_three_time").notNull().default(0),
  reviewState: boolean('review_state').default(false),
  transitionToReview: boolean('transition_to_review').default(false),
  under60ThreeTime: integer("under_60_three_time").notNull().default(0),
...
export const spacedRepetition = pgTable("spacedRepetition", {
  ...
  interval: integer("interval").notNull().default(3),
