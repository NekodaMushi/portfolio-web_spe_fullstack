      ...
      <div className="grid h-screen w-full pl-[53px] pt-6">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className={`rounded-lg ${activeFieldset === "settings" ? "bg-muted" : ""}`}
                  aria-label="Models"
                  onClick={() => setActiveFieldset("settings")}
                >
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  size="icon"
                  className={`rounded-lg ${activeFieldset === "messages" ? "bg-muted" : ""}`}
                  aria-label="Settings"
                  onClick={() => setActiveFieldset("messages")}
                >
        ...
        <div className="flex flex-col">
          ...
          <main className="grid flex-1 gap-4 overflow-auto p-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <ChatBox activeFieldset={activeFieldset} />
          </main>
        </div>
      </div>
    </TooltipProvider>
